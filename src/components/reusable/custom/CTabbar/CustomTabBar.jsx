...
const CustomTabBar = ({ variant = 'default', tabBarData = [], setTabBarData, intialActiveTab = 0, externalActiveTab, setExternalActiveTab }) => {
    ...
    <div className={styles.tabsBox}>
      {
        tabBarData?.map((tab, index) => (
          <div
            ...
            className={`
              ${styles.tab} 
              ${activeTab === index ? (variant === 'underline' ? styles.activeUnderline : styles.active) : ''} 
