...
const AddBankDetails = () => {
            ...
            getData(token)
                .then(({ data, statusCode, error, success }) => {
                    if (statusCode === 200 && success) {
                        ...
                        const { bankName, accountNumber, accountHolderName, bankDocs: bank_detail, _id } = bankData;
            ...
            <CustomModal isOpen={openModal} onClose={() => setOpenModal(false)} >
                <div className={styles.modal} >
                    ...
                    <div className={styles.modalButtonBox}>
                        <CustomButton buttonText={'Cancel'} buttonSize={'small'} onClick={() => setOpenModal(false)} />
                        <CustomButton buttonText={'Continue'} buttonSize={'small'} onClick={handleModalSubmit} />
                    </div>
                </div>
            </CustomModal>
        )
    ...
    if (isLoading) {
        return <div className={styles.formContainer}><Loader /></div>; // Loading state indicator
    }
