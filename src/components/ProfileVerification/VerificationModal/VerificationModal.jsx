    ...
    <div className={styles.mobileModalBox}>
      <div className={styles.mobileModalHeaderBox}>
        <h1 className={styles.modalHeading}>
          {t("verificationModel.heading")}
        </h1>
        <p className={styles.modalDetailsText}>
          {t("verificationModel.subHeading")}
          {maskInput(value)}
        </p>
      </div>
      ...
      <OTPInput
        ...
        inputStyles={
          isMobile ? otpInputDimensions.mobile : otpInputDimensions.tab
        }
      />
      {showResendOtp && (
        <p className={styles.otpNotRecivedText}>
          {t("verificationModel.isOTPRecieved")}
        </p>
      )}
      {showResendOtp && (
        <p className={styles.modalResendCode} onClick={handleResendOtp}>
          {t("verificationModel.resendCode")}
        </p>
      )}
