...
const CustomerFeedback = () => {
    ...
    const feedbackData = {
        ...
        date: "2024-10-01",
        rating: 5,
        feedback: "The app is very user-friendly! I can easily book tickets and check bus schedules without any confusion. The ability to book tickets in advance and select my seat is a game-changer for me. The interface is clean and intuitive, making the whole experience seamless.",
        avatarUrl: "https://randomuser.me/api/portraits/men/32.jpg"
    };

    const getFeedback = async () => {
        const { data, success, statusCode, error } = await apiCall(`${ENDPOINTS.FEEDBACK}?page=${currentPage}&limit=${6}`, 'GET', {
            // headers: {
        ...
        <>
            ...
            <div  className={styles.contentBoxWrapper}>
                ...
                <div className={styles.customerFeedbackBox}>
                    ...
                    {
                        totalPages && <div className={styles.paginationWrapper}>
                            <PaginationComponent
