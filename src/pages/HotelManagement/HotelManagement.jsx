...
import { getDataFromLocalStorage, tokenFromLocalStorage } from '../../utils/helperFunctions';
                    ...
                    if (section?.heading == "Hotel Details") {
                        return {
                            ...
                            details: [
                                ...
                                { name: "Business License", value: businessLicense || "123123123" },
    ...
    return (
        <div className={styles.hotelManagement}>
            ...
            <div className={styles.headerBox}>
                ...
                <div>
                    <CustomButton
                        ...
                        icon={<CiEdit style={{ color: GlobalStyles.colorPrimaryLight, marginRight: '10px' }} />}
                    />
                </div>
            ...
            <div className={styles.contentBox}>
                                    ...
                                    <ul>
                                        {
                                            item?.details?.map((detail, index) => (
                                                <li key={index} className={styles.detailsBoxKey}>{detail?.name}: <span className={styles.textBold}>{detail?.value}</span></li>
                                            ))
                                        }
                                    </ul>
                                </div>
                ...
                {
                    gridImages && <div className={styles.gridLayout}>
                        {
                            gridImages?.map((img, index) => (
                                <div key={index} className={`${styles.gridItem} ${index % 3 == 0 ? styles.featured : ''} `}>
