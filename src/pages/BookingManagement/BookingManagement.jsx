...
const BookingManagement = () => {
    ...
    const getBookings = async () => {
        ...
        const isManagerBooking = bookings?.some(b => b.bookedBy === hotelIdByToken);

        let managerProfile = null;
        if (isManagerBooking) {
            const { data, error, statusCode, success } = await apiCall(`${ENDPOINTS.PROFILE}`, 'GET');
            if (success) {
        ...
        <div className={styles.bookingManagement}>
                    ...
                    <div className={styles.filterAndAddUserBox} >
                        <div className={styles.actionBtn} >
                            <CustomButton
                                ...
                                icon={<LuFilter style={{ fontSize: GlobalStyles.fontSizeSmall, fontWeight: GlobalStyles.fontWeightBold }} />}
                            />
                        </div>
                        ...
                        <div className={`${styles.actionBtn} ${styles.addGuest}`} >
                            <CustomButton
                                ...
                                icon={<IoAdd style={{ fontSize: GlobalStyles.fontSizeSmall, fontWeight: GlobalStyles.fontWeightBold }} />}
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className={styles.tableBoxWrapper} >
                ...
                <CustomTable
                    ...
                    data={bookings || [
                        { bookingId: '01', roomType: 'standard', guestName: 'Harry Potter', mobileNumber: '9876543210', checkIn: '12.09.2025', checkOut: '13.09.2024', adult: 2, child: 1 },
                        { bookingId: '02', roomType: 'luxury', guestName: 'Jane Smith', mobileNumber: '9876543210', checkIn: '12.09.2025', checkOut: '13.09.2024', adult: 2, child: 'N/A' },
                        { bookingId: '03', roomType: 'standard', guestName: 'Dr. Banner', mobileNumber: '9876543210', checkIn: '12.09.2025', checkOut: '13.09.2024', adult: 2, child: 1 },
                    ]}
                    customRowClass="customRow"
                    customCellClass="customCell"
                />
                {
                    bookings.length <= 0 && <p className={styles.dataNotFound} >Data not available.</p>
                }

                {
                    totalPage > 0 && <div className={styles.paginationWrapper}>
                        <PaginationComponent
